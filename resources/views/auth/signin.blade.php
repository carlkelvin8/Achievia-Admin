...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm text-center">
    <!-- App name -->
    <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 mb-2">Achievia</h1>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="{{ route('signin') }}" method="POST">
      ...
      <div>
        ...
        <div class="mt-2">
          <input
            ...
            autocomplete="email"
            required
            class="custom-input block w-full rounded-xl bg-white px-6 py-4 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
          >
        </div>
      </div>
      ...
      <div>
        <button
          type="submit"
          class="flex w-full justify-center rounded-xl bg-black px-5 py-3.5 text-l font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        >
          Sign in
        </button>
      </div>
