...
<body class="min-h-screen flex">
  ...
  src="{{ $teacher->profile_image ? asset('storage/' . $teacher->profile_image) : 'https://via.placeholder.com/190' }}" 
